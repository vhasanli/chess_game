...
board = [
    ...
    [PieceType.BLACK_KNIGHT, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY],  # Empty squares
    ...
    [PieceType.BLACK_KING, PieceType.EMPTY, PieceType.WHITE_KING, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.BLACK_KING, PieceType.BLACK_QUEEN],
    [PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY, PieceType.EMPTY],
